/**
 * SDK Test Script
 * Tests the core SDK functions directly in Node.js
 */
...
console.log('\n========================================');
console.log('  FLOWSTACK SDK TEST SUITE');
console.log('========================================\n');
...
await testAsync('mockDelay works', async () => {
  const start = Date.now();
  await mockDelay(50, 100);
  const elapsed = Date.now() - start;
  assert(elapsed >= 50, `Delay too short: ${elapsed}ms`);
  assert(elapsed < 200, `Delay too long: ${elapsed}ms`);
});
