...
export interface UseInferBalanceReturn {
...
export interface UseBuyInferReturn {
...
export interface UseAgentBalanceReturn {
...
export interface NeedsAgentProps {
