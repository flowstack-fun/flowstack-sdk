...
import { useConfig, injected, http } from 'wagmi';
...
function useWalletAuth() {
  ...
  const login = useCallback(async (method = "privy") => {
    if (method === "privy") {
...
function useDeposit(chain = "arbitrum-sepolia") {
  ...
  const deposit = useCallback(async (inferAmount) => {
...
function useAppAccess(siteId, opts) {
  ...
  const [unlockPriceCents, setUnlockPriceCents] = useState(null);
  const [unlockPriceLabel, setUnlockPriceLabel] = useState(null);
  const [isLoading, setIsLoading] = useState(false);
  const [error, setError] = useState(null);
  const intervalRef = useRef(null);
  const baseUrl = flowstack?.config?.baseUrl || "https://sage-api.flowstack.fun";
...
function WalletProvider({
  ...
  if (!privyAppId) {
    return /* @__PURE__ */ jsx(WalletCtx.Provider, { value: { privyReady: false, baseUrl }, children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children }) });
  }
  return /* @__PURE__ */ jsx(
    PrivyProvider,
    {
      ...
      children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(WagmiProvider, { config: wagmiConfig, children: /* @__PURE__ */ jsx(WalletCtx.Provider, { value: { privyReady: true, baseUrl }, children }) }) })
    }
  );
}
...
function InferBalanceBadge({
  ...
  if (isLoading && !data) {
    return /* @__PURE__ */ jsx("span", { className, style: { ...badgeStyle, opacity: 0.5 }, children: "..." });
  }
  if (!data) return null;
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { style: { color: isLow ? "#d44343" : "#d4a843", fontWeight: 600 }, children: data.queryCredits }),
        /* @__PURE__ */ jsx("span", { style: { color: "#c4bdb3", marginLeft: "4px", fontSize: "12px" }, children: "queries" }),
        isLow && onBuyMore && /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onBuyMore,
            style: {
...
function AgentBalanceBadge({
  ...
  if (isLoading && !data) {
    return /* @__PURE__ */ jsx("span", { className, style: { ...badgeStyle2, opacity: 0.5 }, children: "..." });
  }
  if (!data) return null;
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { style: { color: isLow ? "#d44343" : "#43d4a8", fontWeight: 600 }, children: data.buildCredits }),
        /* @__PURE__ */ jsx("span", { style: { color: "#c4bdb3", marginLeft: "4px", fontSize: "12px" }, children: "builds" }),
        isLow && onBuyMore && /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onBuyMore,
...
function NeedsAgent({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx("div", { style: { opacity: 0.6, pointerEvents: "none" }, children });
  }
  if (hasSufficient) {
    return /* @__PURE__ */ jsx("div", { onClick: onProceed, style: { cursor: "pointer" }, children });
  }
  return /* @__PURE__ */ jsxs("div", { children: [
    children && /* @__PURE__ */ jsx("div", { style: { opacity: 0.5, pointerEvents: "none" }, children }),
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 6 }, children: [
      /* @__PURE__ */ jsxs("p", { style: { margin: 0, fontSize: "0.85em", color: "#888" }, children: [
        "You need ",
        amountNeeded,
...
function PaymentRequired({
  ...
  return /* @__PURE__ */ jsxs("div", { className, style: containerStyle, children: [
    /* @__PURE__ */ jsx("div", { style: { fontSize: "24px", marginBottom: "8px" }, children: "0 queries remaining" }),
    /* @__PURE__ */ jsxs("p", { style: { color: "#c4bdb3", marginBottom: "16px", lineHeight: 1.5 }, children: [
      "Each query costs ",
      inferPerQuery,
      " INFER. Buy more to continue using Casino."
    ] }),
    /* @__PURE__ */ jsx("button", { onClick: onBuy, style: buyButtonStyle, children: "Buy INFER" }),
    /* @__PURE__ */ jsx("p", { style: { color: "#666", fontSize: "12px", marginTop: "12px" }, children: "Pay with credit card. No crypto knowledge needed." }),
    onDismiss && /* @__PURE__ */ jsx("button", { onClick: onDismiss, style: dismissStyle, children: "Maybe later" })
  ] });
}
var containerStyle = {
  textAlign: "center",
...
function BuyInferModal({
  ...
  return /* @__PURE__ */ jsx("div", { style: overlayStyle, onClick: onClose, children: /* @__PURE__ */ jsxs(
    "div",
    {
      className,
      style: modalStyle,
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }, children: [
          /* @__PURE__ */ jsx("h2", { style: { margin: 0, fontSize: "20px", color: "#f5f0e8" }, children: "Buy Query Credits" }),
          /* @__PURE__ */ jsx("button", { onClick: onClose, style: closeStyle, children: "\xD7" })
        ] }),
        /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: "12px", marginBottom: "24px" }, children: TIERS.map((tier, i) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { style: { fontWeight: 600, fontSize: "16px", color: "#f5f0e8" }, children: [
                tier.queries,
                " queries"
              ] }),
              /* @__PURE__ */ jsxs("div", { style: { color: "#d4a843", fontWeight: 700, fontSize: "18px" }, children: [
                "$",
                tier.price
              ] })
            ]
        ...
        /* @__PURE__ */ jsx("p", { style: { color: "#666", fontSize: "12px", textAlign: "center", marginTop: "12px" }, children: "Powered by MoonPay. Visa, Mastercard, Apple Pay accepted." })
      ]
    }
  ) });
}
...
function AppPaywall({ siteId, builderTenantId, children, onBlocked }) {
  ...
  const [serverBlockReason, setServerBlockReason] = useState(null);
  useEffect(() => {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            reason === "free_tier_exhausted" && /* @__PURE__ */ jsx("p", { style: { fontSize: "13px", color: "#aaa", marginBottom: "20px" }, children: "You've used your free queries for this month. Unlock unlimited access below." }),
            reason === "payment_required" && /* @__PURE__ */ jsx("p", { style: { fontSize: "13px", color: "#aaa", marginBottom: "20px" }, children: "This app requires payment to access." }),
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => checkout(),
...
export { AgentBalanceBadge, AppPaywall, BuyInferModal, InferBalanceBadge, LoginButton, NeedsAgent, PaymentRequired, WalletProvider, useAgentBalance, useAppAccess, useBuyInfer, useDeposit, useInferBalance, useWalletAuth };
